...
import com.spring.main.restservice.Persona;
...
public class PersonaDB {
  ...
  public static String actualizarCliente(HashMap<String, String> datos) {
    ...
    try {
      DbConnection.dbUpdate(query, new String[] {
          datos.get("id_gestor"),
          datos.get("nombre"),
          datos.get("apellido"),
          datos.get("usuario"),
  ...
  public static ArrayList<Persona> devolverClientes(int id){
  ...
  public static ArrayList<Persona> devolverGestores(int id){
  ...
  public static ArrayList<Persona> devolverClientesDeGestor(int id){
